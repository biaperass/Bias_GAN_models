...
5. **Run dataset_tool.py** — converts each image folder into the `.zip`/folder format Projected-GAN expects, output to `data/waterbirds_rho_gan/waterbirds_256_{rho}/`
...
└── waterbirds_rho_gan/               # Projected-GAN formatted datasets (output of dataset_tool.py)
